...
class SuperOptimizer(
    ...
    def __init__(self,StateFunctions =["Word2vec","Doc2vec","Bert","Actionhistory"],
        RewardFunctions = ["relative_measure","tan","func","weight"],
        RLAlgorithms = ["MCTS","PPO","DQN","QLearning"],
        ActionFunctions = ["init"],
        datapath='/home/huanting/CG/MTL_test/tasks/halide_env/resource'):
    ...
    def PolicyDefined(self):
        ...
        self.policy_all = [dict(zip(self.policy, v)) for v in product(*self.policy.values())]
