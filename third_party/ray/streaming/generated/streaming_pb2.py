...
_LANGUAGE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="JAVA", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PYTHON", index=1, number=1, serialized_options=None, type=None
        ),
    ],
...
_NODETYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="SOURCE", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TRANSFORM", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SINK", index=3, number=3, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_FLOWCONTROLTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="UNKNOWN_FLOW_CONTROL_TYPE",
            index=0,
            number=0,
            serialized_options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="NoFlowControl", index=2, number=2, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_STREAMINGCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="job_name",
            full_name="ray.streaming.proto.StreamingConfig.job_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="worker_name",
            full_name="ray.streaming.proto.StreamingConfig.worker_name",
            index=1,
            number=3,
            type=9,
            cpp_type=9,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="workerName",
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="op_name",
            full_name="ray.streaming.proto.StreamingConfig.op_name",
            index=2,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="role",
            full_name="ray.streaming.proto.StreamingConfig.role",
            index=3,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="ray.streaming.proto.StreamingConfig.ring_buffer_capacity",
            index=4,
            number=6,
            type=13,
            cpp_type=3,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="ringBufferCapacity",
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="empty_message_interval",
            full_name="ray.streaming.proto.StreamingConfig.empty_message_interval",
            index=5,
            number=7,
            type=13,
            cpp_type=3,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="emptyMessageInterval",
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="flow_control_type",
            full_name="ray.streaming.proto.StreamingConfig.flow_control_type",
            index=6,
            number=8,
            type=14,
            cpp_type=8,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="flowControlType",
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="writer_consumed_step",
            full_name="ray.streaming.proto.StreamingConfig.writer_consumed_step",
            index=7,
            number=9,
            type=13,
            cpp_type=3,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="writerConsumedStep",
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="reader_consumed_step",
            full_name="ray.streaming.proto.StreamingConfig.reader_consumed_step",
            index=8,
            number=10,
            type=13,
            cpp_type=3,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="readerConsumedStep",
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="event_driven_flow_control_interval",
            full_name="ray.streaming.proto.StreamingConfig.event_driven_flow_control_interval",
            index=9,
            number=11,
            type=13,
            cpp_type=3,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="eventDrivenFlowControlInterval",
            file=DESCRIPTOR,
        ),
    ],
    extensions=[],
