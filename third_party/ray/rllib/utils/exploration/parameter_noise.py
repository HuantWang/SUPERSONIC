...
class ParameterNoise(Exploration):
    ...
    def before_compute_actions(self, *, timestep=None, explore=None, tf_sess=None):
    ...
    def postprocess_trajectory(self, policy, sample_batch, tf_sess=None):
        ...
        if policy.dist_class in (Categorical, TorchCategorical):
            ...
            current_epsilon = self.sub_exploration.get_info(sess=tf_sess)["cur_epsilon"]
            ...
            current_scale = self.sub_exploration.get_info(sess=tf_sess)["cur_scale"]
