...
class MicrobatchOptimizer(PolicyOptimizer):
    ...
    def step(self):
        ...
        while samples_so_far < self.train_batch_size:
            ...
            with self.grad_timer:
                for policy_id, policy in self.policies.items():
                    ...
                    grad_out, info_out = self.workers.local_worker().compute_gradients(
                    ...
                    if policy_id not in accumulated_gradients:
                        ...
                        c = []
                        for a, b in zip(accumulated_gradients[policy_id], grad):
                            c.append(a + b)
        ...
        logger.info(
            "Applying accumulated gradients ({} samples)".format(samples_so_far)
        )
