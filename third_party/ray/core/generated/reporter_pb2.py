...
_GETPROFILINGSTATSREPLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='profilingStats', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stdout', full_name='ray.rpc.GetProfilingStatsReply.stdout', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='stdout', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stderr', full_name='ray.rpc.GetProfilingStatsReply.stderr', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='stderr', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
