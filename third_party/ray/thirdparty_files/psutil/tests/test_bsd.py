...
class FreeBSDSystemTestCase(unittest.TestCase):
    ...
    def test_vmem_active(self):
        ...
        self.assertAlmostEqual(
            psutil.virtual_memory().active, syst, delta=MEMORY_TOLERANCE
        )
    ...
    def test_vmem_inactive(self):
        ...
        self.assertAlmostEqual(
            psutil.virtual_memory().inactive, syst, delta=MEMORY_TOLERANCE
        )
    ...
    def test_vmem_wired(self):
        ...
        self.assertAlmostEqual(
            psutil.virtual_memory().wired, syst, delta=MEMORY_TOLERANCE
        )
    ...
    def test_vmem_cached(self):
        ...
        self.assertAlmostEqual(
            psutil.virtual_memory().cached, syst, delta=MEMORY_TOLERANCE
        )
    ...
    def test_vmem_free(self):
        ...
        self.assertAlmostEqual(
            psutil.virtual_memory().free, syst, delta=MEMORY_TOLERANCE
        )
    ...
    def test_vmem_buffers(self):
        ...
        self.assertAlmostEqual(
            psutil.virtual_memory().buffers, syst, delta=MEMORY_TOLERANCE
        )
    ...
    def test_muse_vmem_active(self):
        num = muse("Active")
        self.assertAlmostEqual(
            psutil.virtual_memory().active, num, delta=MEMORY_TOLERANCE
        )
    ...
    def test_muse_vmem_inactive(self):
        num = muse("Inactive")
        self.assertAlmostEqual(
            psutil.virtual_memory().inactive, num, delta=MEMORY_TOLERANCE
        )
    ...
    def test_muse_vmem_wired(self):
        num = muse("Wired")
        self.assertAlmostEqual(
            psutil.virtual_memory().wired, num, delta=MEMORY_TOLERANCE
        )
    ...
    def test_muse_vmem_cached(self):
        num = muse("Cache")
        self.assertAlmostEqual(
            psutil.virtual_memory().cached, num, delta=MEMORY_TOLERANCE
        )
    ...
    def test_muse_vmem_free(self):
        num = muse("Free")
        self.assertAlmostEqual(
            psutil.virtual_memory().free, num, delta=MEMORY_TOLERANCE
        )
    ...
    def test_muse_vmem_buffers(self):
        num = muse("Buffer")
        self.assertAlmostEqual(
            psutil.virtual_memory().buffers, num, delta=MEMORY_TOLERANCE
        )
