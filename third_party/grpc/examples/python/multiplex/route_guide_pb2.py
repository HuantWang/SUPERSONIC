...
try:
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
        ...
        method_implementations = {
            ("routeguide.RouteGuide", "GetFeature"): face_utilities.unary_unary_inline(
                servicer.GetFeature
            ),
            (
            ...
            ("routeguide.RouteGuide", "RouteChat"): face_utilities.stream_stream_inline(
                servicer.RouteChat
            ),
        }
    ...
    def beta_create_RouteGuide_stub(
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
        ...
        return beta_implementations.dynamic_stub(
            channel, "routeguide.RouteGuide", cardinalities, options=stub_options
        )
