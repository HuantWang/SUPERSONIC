...
_PAYLOADTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="COMPRESSABLE", index=0, number=0, options=None, type=None
        ),
    ],
...
_BOOLVALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="grpc.testing.BoolValue.value",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
_PAYLOAD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="type",
            full_name="grpc.testing.Payload.type",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="body",
            full_name="grpc.testing.Payload.body",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_ECHOSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="code",
            full_name="grpc.testing.EchoStatus.code",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="grpc.testing.EchoStatus.message",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SIMPLEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="response_type",
            full_name="grpc.testing.SimpleRequest.response_type",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="response_size",
            full_name="grpc.testing.SimpleRequest.response_size",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="payload",
            full_name="grpc.testing.SimpleRequest.payload",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="fill_username",
            full_name="grpc.testing.SimpleRequest.fill_username",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="grpc.testing.SimpleRequest.fill_oauth_scope",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="grpc.testing.SimpleRequest.response_compressed",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="grpc.testing.SimpleRequest.response_status",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="grpc.testing.SimpleRequest.expect_compressed",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
...
_SIMPLERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="payload",
            full_name="grpc.testing.SimpleResponse.payload",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="username",
            full_name="grpc.testing.SimpleResponse.username",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="oauth_scope",
            full_name="grpc.testing.SimpleResponse.oauth_scope",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_STREAMINGINPUTCALLREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="payload",
            full_name="grpc.testing.StreamingInputCallRequest.payload",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="expect_compressed",
            full_name="grpc.testing.StreamingInputCallRequest.expect_compressed",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_STREAMINGINPUTCALLRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="grpc.testing.StreamingInputCallResponse.aggregated_payload_size",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
_RESPONSEPARAMETERS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="size",
            full_name="grpc.testing.ResponseParameters.size",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="interval_us",
            full_name="grpc.testing.ResponseParameters.interval_us",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="compressed",
            full_name="grpc.testing.ResponseParameters.compressed",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_STREAMINGOUTPUTCALLREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="response_type",
            full_name="grpc.testing.StreamingOutputCallRequest.response_type",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="grpc.testing.StreamingOutputCallRequest.response_parameters",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="payload",
            full_name="grpc.testing.StreamingOutputCallRequest.payload",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="response_status",
            full_name="grpc.testing.StreamingOutputCallRequest.response_status",
            index=3,
            number=7,
            type=11,
            cpp_type=10,
...
_STREAMINGOUTPUTCALLRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="payload",
            full_name="grpc.testing.StreamingOutputCallResponse.payload",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_RECONNECTPARAMS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="grpc.testing.ReconnectParams.max_reconnect_backoff_ms",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
_RECONNECTINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="passed",
            full_name="grpc.testing.ReconnectInfo.passed",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="backoff_ms",
            full_name="grpc.testing.ReconnectInfo.backoff_ms",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_STREAMINGOUTPUTCALLREQUEST.fields_by_name[
    "response_parameters"
].message_type = _RESPONSEPARAMETERS
...
EchoStatus = _reflection.GeneratedProtocolMessageType(
    "EchoStatus",
    (_message.Message,),
    dict(
...
SimpleRequest = _reflection.GeneratedProtocolMessageType(
    "SimpleRequest",
    (_message.Message,),
    dict(
...
StreamingInputCallRequest = _reflection.GeneratedProtocolMessageType(
    "StreamingInputCallRequest",
    (_message.Message,),
    dict(
...
StreamingInputCallResponse = _reflection.GeneratedProtocolMessageType(
    "StreamingInputCallResponse",
    (_message.Message,),
    dict(
...
ResponseParameters = _reflection.GeneratedProtocolMessageType(
    "ResponseParameters",
    (_message.Message,),
    dict(
...
StreamingOutputCallRequest = _reflection.GeneratedProtocolMessageType(
    "StreamingOutputCallRequest",
    (_message.Message,),
    dict(
...
StreamingOutputCallResponse = _reflection.GeneratedProtocolMessageType(
    "StreamingOutputCallResponse",
    (_message.Message,),
    dict(
...
ReconnectParams = _reflection.GeneratedProtocolMessageType(
    "ReconnectParams",
    (_message.Message,),
    dict(
...
ReconnectInfo = _reflection.GeneratedProtocolMessageType(
    "ReconnectInfo",
    (_message.Message,),
    dict(
