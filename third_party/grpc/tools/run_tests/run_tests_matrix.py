...
if __name__ == "__main__":
    ...
    report_utils.render_junit_xml_report(
        resultset, _report_filename("aggregate_tests"), suite_name="aggregate_tests"
    )
    ...
    if num_failures == 0:
        ...
        jobset.message(
            "FAILED", "Some run_tests.py instance have failed.", do_newline=True
        )
        sys.exit(1)
