...
class ChannelConnectivityTest(unittest.TestCase):
    def test_lonely_channel_connectivity(self):
        ...
        self.assertSequenceEqual((grpc.ChannelConnectivity.IDLE,), first_connectivities)
    ...
    def test_immediately_connectable_channel_connectivity(self):
        ...
        first_connectivities = first_callback.block_until_connectivities_satisfy(bool)
        ...
        fourth_connectivities = second_callback.block_until_connectivities_satisfy(bool)
        ...
        self.assertNotIn(grpc.ChannelConnectivity.SHUTDOWN, third_connectivities)
        self.assertNotIn(
            grpc.ChannelConnectivity.TRANSIENT_FAILURE, fourth_connectivities
        )
        self.assertNotIn(grpc.ChannelConnectivity.SHUTDOWN, fourth_connectivities)
