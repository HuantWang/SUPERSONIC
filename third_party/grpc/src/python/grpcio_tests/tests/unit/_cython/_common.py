...
class OperationResult(
    collections.namedtuple(
        "OperationResult", ("start_batch_result", "completion_type", "success",)
    )
):
    pass
...
class RpcTest(object):
    def setUp(self):
        ...
        self.server.start()
        self.channel = cygrpc.Channel("localhost:{}".format(port).encode(), [], None)
    ...
    def tearDown(self):
        self.server.shutdown(self.server_completion_queue, self._server_shutdown_tag)
