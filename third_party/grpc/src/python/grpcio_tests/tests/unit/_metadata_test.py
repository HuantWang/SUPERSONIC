...
_INVOCATION_METADATA = (
    (b"invocation-md-key", u"invocation-md-value",),
...
_INITIAL_METADATA = (
    (b"initial-md-key", u"initial-md-value"),
...
def validate_client_metadata(test, servicer_context):
    ...
    test.assertTrue(user_agent.startswith("primary-agent " + _channel._USER_AGENT))
...
class MetadataTest(unittest.TestCase):
    def setUp(self):
        ...
        self._server.add_generic_rpc_handlers((_GenericHandler(weakref.proxy(self)),))
