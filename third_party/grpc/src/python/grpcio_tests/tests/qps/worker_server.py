...
import grpc
from SuperSonic.proto.grpc.testing import control_pb2
from SuperSonic.proto.grpc.testing import worker_service_pb2_grpc
from SuperSonic.proto.grpc.testing import stats_pb2
...
class WorkerServer(worker_service_pb2_grpc.WorkerServiceServicer):
    ...
    def _get_server_status(self, start_time, end_time, port, cores):
        ...
        stats = stats_pb2.ServerStats(
            time_elapsed=elapsed_time, time_user=elapsed_time, time_system=elapsed_time
        )
    ...
    def RunClient(self, request_iterator, context):
        ...
        qps_data = histogram.Histogram(
            config.histogram_params.resolution, config.histogram_params.max_possible
        )
        start_time = time.time()
