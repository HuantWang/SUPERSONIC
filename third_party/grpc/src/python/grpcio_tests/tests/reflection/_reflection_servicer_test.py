...
from SuperSonic.proto.grpc.testing.proto2 import empty2_extensions_pb2
...
class ReflectionServicerTest(unittest.TestCase):
    ...
    def testFileByName(self):
        requests = (
            ...
            reflection_pb2.ServerReflectionRequest(file_by_filename="i-donut-exist"),
        )
        ...
        requests = (
            reflection_pb2.ServerReflectionRequest(
                file_containing_extension=reflection_pb2.ExtensionRequest(
                    containing_type=_EMPTY_EXTENSIONS_SYMBOL_NAME, extension_number=125,
                ),
            ),
            reflection_pb2.ServerReflectionRequest(
                file_containing_extension=reflection_pb2.ExtensionRequest(
