...
class _GenericStub(face.GenericStub):
    def __init__(
        self, channel, metadata_transformer, request_serializers, response_deserializers
    ):
        self._channel = channel
        self._metadata_transformer = metadata_transformer
...
def generic_stub(
    channel, host, metadata_transformer, request_serializers, response_deserializers
):
    return _GenericStub(
        channel, metadata_transformer, request_serializers, response_deserializers
    )
